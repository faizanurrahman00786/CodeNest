# Getting Started with CodeNest App

This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).

### `npm start`

Open [https://codenest-pi.vercel.app/] to view it in your browser.
...
* Enrolled Courses: This page will have a list of all the courses available on the platform,
...
* My Courses: This page will have detailed insights into the instructor's courses,
...
1. User schema: Includes fields such as name, email, password, and course details
for each student.
2. Profile schema: Includes fields such as name, email, DOB, and gender
details for each user.
3. Course schema: Includes fields such as course name, description, instructor details,
and media content.
4. Subsection schema: Includes fields such as lecture name, description, lecture details,
and media content.
5. Rating review schema: Includes fields such as course name, usreID, review rating.
...
1. /api/v1/auth/signup (POST) - Create a new user (student or instructor) account.
2. /api/v1/auth/login (POST) – Log in using existing credentials and generate a JWT
token.
3. /api/v1/auth/verify-otp (POST) - Verify the OTP sent to the user's registered email.
4. /api/v1/auth/reset-password (POST) - Send an email with a OTP to reset password using
the registered email.
5. /api/v1/course/getAllCourses (GET) - Get a list of all available courses.
6. /api/v1/courses/:id (GET) - Get details of a specific course by ID.
7. /api/v1/courses (POST) - Create a new course.
8. /api/v1/courses/:id (PUT) - Update an existing course by ID.
10. /api/v1/courses/:id/rate (POST) - Add a rating (out of 5) to a course.
